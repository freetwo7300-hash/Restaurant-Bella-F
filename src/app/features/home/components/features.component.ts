    ...
    <section class="py-20 md:py-32 bg-black overflow-hidden">
      <div class="container mx-auto px-6 md:px-12">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 md:mb-20 gap-8">
          <div class="max-w-2xl">
            <div class="text-accent text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] mb-4 md:mb-6">Welcome to BELLA</div>
            <h2 class="text-4xl sm:text-5xl md:text-6xl font-bold leading-[1.1] tracking-tighter">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div *ngFor="let feature of features" class="group relative">
            <div class="aspect-[3/4] overflow-hidden rounded-xl mb-6 bg-zinc-900 border border-white/5">
            ...
            <h3 class="text-xl md:text-2xl font-bold mb-3 tracking-tight">{{ feature.title }}</h3>
            <p class="text-gray-400 text-sm leading-relaxed max-w-xs md:max-w-[200px]">
              {{ feature.desc }}
            </p>
          </div>
        </div>
